...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2020 at 10:41 AM
...
('mimin', 123456789, 32, 'UMY', 1, 5, 1, 1, 1, 1),
('ngadikin', 100046, 53, 'UMY', 1, 6, 1, 1, 1, 1),
('Arlina', 173069, 51, 'MMR', 2, 7, 1, 1, 1, 1),
('bambang rahmanto', 100235, 54, 'rektorat', 1, 8, 1, 0, 0, 1),
('murfiandi', 1000103, 49, 'FKIK', 1, 9, 1, 0, 0, 1),
('Meilydia Nur Hidayati', 401311, 23, 'rektorat', 2, 10, 1, 0, 0, 1),
('supardwiyana', 100247, 55, 'satpam', 1, 11, 1, 0, 0, 0),
('Naula Rahma', 401397, 23, 'rektorat', 2, 12, 1, 0, 0, 0),
('wanto saputro', 100236, 52, 'FPB', 1, 13, 1, 0, 0, 0),
('Dafnan Arif Febrianto', 100278, 47, 'FEB', 1, 14, 1, 0, 0, 0),
('Nurhidayat', 100133, 48, 'FT', 1, 15, 1, 0, 0, 0),
('budi raharjo', 100272, 48, 'FT', 1, 16, 1, 0, 0, 0),
('Agus sutopo', 100342, 48, 'Fisipol', 1, 17, 1, 0, 0, 0),
('Bella Noermalitasari', 401276, 56, 'FEB', 2, 18, 1, 0, 0, 0),
('Delina Auza Utami', 0, 39, 'BBTKLPP Jogja', 2, 19, 1, 0, 0, 0),
('Wury Prastuti', 1000007, 49, 'Fisipol', 2, 21, 1, 0, 0, 0),
('Andi Maryanto', 1700018001, 21, 'mahasiswa', 1, 27, 1, 1, 1, 1);
