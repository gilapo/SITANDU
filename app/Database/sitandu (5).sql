...
INSERT INTO `t_detail_kesehatan` (`id_detail_kesehatan`, `bb`, `tb`, `imt`, `lp`, `ape`, `sistole`, `diastole`, `jenis_gd`, `gds`, `kolesterol`, `asam_urat`, `ekspirasi`, `benjolan_pada_payudara`, `iva`, `kadar_alkohol`, `tes_amfetamin`) VALUES
(5, 170, 70, 24, 0, 'laki-laki', 135, 85, 'gds', 150, 210, 8, 0, 1, 0, 1, 0),
(6, 60, 159, 24, 0, 'laki-laki', 140, 83, 'gds', 106, 151, 0, 0, 0, 0, 1, 0),
(7, 67, 161, 26, 0, 'perempuan', 108, 74, 'gds', 0, 252, 0, 0, 0, 0, 0, 0),
(8, 0, 0, 0, 0, '', 33, 33, 'gds', 33, 33, 33, 33, NULL, 1, 0, 1),
(36, 33, 33, 303.03, 33, 'laki-laki', 33, 33, 'gds', 33, 33, 33, 33, 1, 0, 1, 0),
(39, 51, 173, 0.00170403, 30, 'laki-laki', 120, 80, 'gds', 140, 80, 80, 500, 0, 0, 0, 0);
...
(36, 'ttt', 'ttt', 'ttt'),
(39, 'susah tidur', 'makan yang banyak\r\n', '-');
...
INSERT INTO `t_pasien` (`id`, `nama`, `identitas`, `usia`, `jabatan`, `jeniskelamin`, `tanggal_input`, `status_meja_2`, `status_meja_3`, `status_meja_4`, `status_meja_5`) VALUES
(5, 'mimin', 123456789, 32, 'UMY', 1, NULL, 1, 1, 1, 1),
(6, 'ngadikin', 100046, 53, 'UMY', 1, NULL, 1, 1, 1, 1),
(7, 'Arlina', 173069, 51, 'MMR', 0, NULL, 1, 1, 1, 1),
(8, 'bambang rahmanto', 100235, 54, 'rektorat', 1, NULL, 1, 0, 1, 1),
(9, 'murfiandi', 1000103, 49, 'FKIK', 1, NULL, 1, 0, 0, 1),
(10, 'Meilydia Nur Hidayati', 401311, 23, 'rektorat', 0, NULL, 1, 0, 0, 1),
(11, 'supardwiyana', 100247, 55, 'satpam', 1, NULL, 1, 0, 0, 0),
(12, 'Naula Rahma', 401397, 23, 'rektorat', 0, NULL, 1, 0, 0, 0),
(13, 'wanto saputro', 100236, 52, 'FPB', 1, NULL, 1, 0, 0, 0),
(14, 'Dafnan Arif Febrianto', 100278, 47, 'FEB', 1, NULL, 1, 0, 0, 0),
(15, 'Nurhidayat', 100133, 48, 'FT', 1, NULL, 1, 0, 0, 0),
(16, 'budi raharjo', 100272, 48, 'FT', 1, NULL, 1, 0, 0, 0),
(17, 'Agus sutopo', 100342, 48, 'Fisipol', 1, NULL, 1, 0, 0, 0),
(18, 'Bella Noermalitasari', 401276, 56, 'FEB', 0, NULL, 1, 0, 0, 0),
(19, 'Delina Auza Utami', 0, 39, 'BBTKLPP Jogja', 0, NULL, 1, 0, 0, 0),
(21, 'Wury Prastuti', 1000007, 49, 'Fisipol', 0, NULL, 1, 0, 0, 0),
(36, 'Agus sutopo', 100342, 48, 'Fisipol', 1, '2020-09-06', 1, 1, 1, 1),
(39, 'alif putra', 123456789, 29, 'mahasiswa', 1, '2020-09-05', 1, 1, 1, 1);
...
--
ALTER TABLE `t_detail_kesehatan`
  MODIFY `id_detail_kesehatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `t_faktor_resiko`
--
ALTER TABLE `t_faktor_resiko`
  MODIFY `id_faktor_resiko` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `t_konseling`
--
ALTER TABLE `t_konseling`
  MODIFY `id_kesimpulan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `t_tidak_menular_diri`
  MODIFY `id_penyakit_diri_sendiri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `t_tidak_menular_keluarga`
--
ALTER TABLE `t_tidak_menular_keluarga`
  MODIFY `id_penyakit_keluarga` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
